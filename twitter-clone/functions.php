<?php
    ...
    $link = mysqli_connect("sdb-h.hosting.stackcp.net","twitter-313836eed8","4ky>A@;a42&m","twitter-313836eed8");
    ...
    function displaySearch() {
        echo '<form> <div class="row g-3 align-items-center">
          <div class="col-auto">
          <input type="hidden" name="page" value="search">
            <input type="text" name="q" id="search" class="form-control" aria-describedby="passwordHelpInline" placeholder = "Search">
          </div>
          <div class="col-auto">
    ...
    function displayTweetBox() {
        ...
        if ($_SESSION['id'] > 0) {
            echo '<div id="tweetSuccess" class="alert alert-success">Your tweet was posted successfully.</div> <div id="tweetFail" class="alert alert-danger"></div> <div class="row g-3 align-items-center">
          <div>
            <textarea id="tweetContent" class="form-control" aria-describedby="passwordHelpInline"></textarea>
          </div>
          <div>
    ...
    function displayUsers(){
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<div><p><a href='?page=publicprofiles&userid=".$row['id']."'>".$row['email']."</a></p></div>";
        }
    }
